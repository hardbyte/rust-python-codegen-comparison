...
```python
from axum_server_client import AuthenticatedClient
...
```python
from axum_server_client.models import MyDataModel
from axum_server_client.api.my_tag import get_my_data_model
from axum_server_client.types import Response
...
1. Any endpoint which did not have a tag will be in `axum_server_client.api.default`
